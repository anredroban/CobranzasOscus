...
class gsp_cobranzasOscus_reportesbitacoraPrincipales_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/reportes/bitacoraPrincipales.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('select','g',26,['class':("form-control"),'name':("nombreBase"),'multiple':("true"),'size':("10"),'required':(""),'from':(utilitarios.Util.getNombresBase())],-1)
printHtmlPart(3)
invokeTag('submitButton','g',29,['class':("btn btn-primary"),'name':("btnEnviar"),'value':("Enviar")],-1)
printHtmlPart(4)
})
invokeTag('form','g',31,['action':("bitacoraPrincipales"),'class':("col-lg-12")],1)
printHtmlPart(5)
}
...
public static final long LAST_MODIFIED = 1545427272296L
