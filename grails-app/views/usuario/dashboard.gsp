...
<head>
    ...
    <title>Cobranzas Oscus - Dashboard</title>
...
<div class="container-fluid">
                ...
                <div class="panel panel-dark-gray">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getValorPromesaDiario()}</div>
                                <div>¡Monto Recuperado Diario!</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-dark-gray">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getPromesas()}</div>
                                <div>¡Promesas!</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-dark-gray">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge">${Util.getValorPromesaRegestionable()}</div>
                                <div>¡Monto Promesas!</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="panel panel-border-lila">
                <div class="panel-heading panel-body-lila">
                    <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Reporte de Ventas Diarias</h3>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="panel panel-border-plomo-oscuro">
                <div class="panel-heading panel-body-plomo-oscuro">
                    <h3 style="color: white" class="panel-title"><i class="fa fa-money fa-fw"></i> Reporte de Montos Recuperados Diarios</h3>
                    <a class="btn btn-plomo-oscuro btn-clickable pull-right" onclick="return false;" href="#">
                        <i class="fa fa-chevron-down"></i>
                    </a>
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <div id="containerlinereportmontos" style="min-width: 310px; height: 400px; max-width: 1000px; margin: 0 auto"></div>
                    </div>
                </div>
            </div>
        </div>
