...
class gsp_cobranzasOscus_layoutsmain_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('layoutTitle','g',8,['default':("Cobranzas Oscus")],-1)
})
...
invokeTag('link','g',55,['action':("logout"),'controller':("usuario")],3)
printHtmlPart(17)
...
printHtmlPart(20)
invokeTag('render','g',71,['template':("/layouts/sidebar")],-1)
printHtmlPart(21)
invokeTag('layoutBody','g',77,[:],-1)
printHtmlPart(22)
invokeTag('render','g',82,['template':("/layouts/operatorbar")],-1)
printHtmlPart(23)
invokeTag('javascript','asset',104,['src':("main/bootstrap.min.js")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',105,['src':("telephony/operatorbar.js")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',107,['src':("telephony/asteriskAmi.js")],-1)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1628278514509L
