        ...
        if (params.consultants && params.dbName && params.tipoRegx && params.allocationNumber) {
            ...
            if(tipoRegistros.equalsIgnoreCase("SIN GESTION")){
                ...
                if(tipoRegistros.equalsIgnoreCase("RELLAMADAS")){
                    ...
                    sql = "from Clientes where usuario.rol != :rol and nombreBase = :nombreBase and intentos != 0 and plataforma != 'PURE CLOUD' ${condicionSubestadoAsignacion} ${condicionEasyDesde} ${condicionEasyHasta} ${condicionIntentosDesde} ${condicionIntentosHasta}  ${condicionSubestado} order by intentos"
                }
