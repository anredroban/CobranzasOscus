...
<div class="container-fluid">
    <g:form action = "bitacoraContencion" class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i class="fa fa-archive"></i>  Trama Contención BP
            </li>
        </ol>
    <%-- <div class=" form-group col-lg-12">
        ...
        <div class="form-group col-lg-6">
            ...
            <g:select class="form-control" name="nombreBase" multiple="true" size="10" required="" from="${utilitarios.Util.getCodigoCampania()}"></g:select>
        </div>
        <div class="col-lg-12">
