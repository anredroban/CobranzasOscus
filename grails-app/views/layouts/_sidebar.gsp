		...
		<g:if test="${Util.checkAccess(session.user.usuario, '/permiso/index') || Util.checkAccess(session.user.usuario, '/rol/index') || Util.checkAccess(session.user.usuario, '/usuario/index')}">
			...
			<g:if test="${Util.checkAccess(session.user.usuario, '/reportes/bitacoraPrincipales')||Util.checkAccess(session.user.usuario, '/reportes/gerencial')}">
				...
				<ul id="sub-reportes" class="collapse nav-sub">
					...
					<%--<g:if test="${Util.checkAccess(session.user.usuario, '/reportes/bitacoraContencion')}">
						<li class="nav-reports
							<g:if test="${actionName == "bitacoraContencion"}">
							nav-active subnav-expanded
						</g:if>
						">
							<a href="${createLink(uri: '/reportes/bitacoraContencion')}">
								<i class="fa fa-fw fa-table"></i><span class="menu-name">&nbsp;Trama Cobranzas JEP</span>
							</a>
						</li>
					</g:if>--%>
					...
					<g:if test="${Util.checkAccess(session.user.usuario, '/reportes/bitacoraGestion')}">
						...
						">
							<a href="${createLink(uri: '/reportes/bitacoraGestion')}">
								<i class="fa fa-fw fa-table"></i><span class="menu-name">&nbsp;Trama Gestión</span>
							</a>
						</li>
					</g:if>
					...
					<g:if test="${Util.checkAccess(session.user.usuario, '/reportes/gerencial')}">
						<li class="nav-reports
						<g:if test="${actionName == "gerencial"}">
							nav-active subnav-expanded
						</g:if>
						">
							<a href="${createLink(uri: '/reportes/creditos')}">
								<i class="fa fa-fw fa-table"></i><span class="menu-name">&nbsp;Creditos</span>
							</a>
						</li>
					</g:if>--%>
				</ul>
