...
class gsp_cobranzasOscus_usuarioedit_gsp extends GroovyPage {
...
printHtmlPart(18)
invokeTag('actionSubmit','g',45,['class':("form-control btn btn-success"),'action':("update"),'value':("Actualizar")],-1)
printHtmlPart(19)
})
invokeTag('form','g',45,['url':([resource:usuarioInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1556747858221L
