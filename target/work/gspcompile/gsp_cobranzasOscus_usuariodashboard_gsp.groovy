...
class gsp_cobranzasOscus_usuariodashboard_gsp extends GroovyPage {
...
expressionOut.print(createLink(uri:'#'))
printHtmlPart(20)
expressionOut.print(Util.getValorPromesaDiario())
printHtmlPart(21)
expressionOut.print(createLink(uri:'#'))
printHtmlPart(22)
expressionOut.print(Util.getPromesas())
printHtmlPart(23)
expressionOut.print(createLink(uri:'#'))
printHtmlPart(22)
expressionOut.print(Util.getValorPromesaRegestionable())
printHtmlPart(24)
for( _it20292768 in (inicioSesion) ) {
changeItVariable(_it20292768)
printHtmlPart(25)
...
printHtmlPart(28)
for( _it1758135550 in (ventasPorUsuario) ) {
changeItVariable(_it1758135550)
printHtmlPart(29)
expressionOut.print(it[0])
printHtmlPart(26)
...
printHtmlPart(30)
for( _it1756689777 in (tablaResult) ) {
changeItVariable(_it1756689777)
printHtmlPart(25)
expressionOut.print(it[0])
printHtmlPart(26)
expressionOut.print(it[1])
...
invokeTag('captureBody','sitemesh',381,[:],1)
printHtmlPart(34)
}
...
public static final long LAST_MODIFIED = 1628786851712L
