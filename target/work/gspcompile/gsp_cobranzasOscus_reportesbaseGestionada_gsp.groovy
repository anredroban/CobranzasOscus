...
class gsp_cobranzasOscus_reportesbaseGestionada_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('submitButton','g',27,['class':("btn btn-info"),'name':("btnEnviar"),'value':("Generar Excel")],-1)
printHtmlPart(3)
})
invokeTag('form','g',27,['action':("baseGestionada"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1582041956361L
