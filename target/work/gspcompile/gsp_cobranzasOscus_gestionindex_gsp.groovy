...
class gsp_cobranzasOscus_gestionindex_gsp extends GroovyPage {
...
printHtmlPart(5)
invokeTag('sortableColumn','g',28,['property':("descripcion"),'title':(message(code: 'gestion.descripcion.label', default: 'Base'))],-1)
printHtmlPart(6)
invokeTag('sortableColumn','g',30,['property':("descripcion"),'title':(message(code: 'gestion.descripcion.label', default: 'Subestado'))],-1)
printHtmlPart(6)
...
invokeTag('link','g',40,['action':("gestionCliente"),'class':("linkcliente"),'id':(cliente.id)],3)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1628278514323L
