...
class gsp_cobranzasOscus_reportesbitacoraGestion_gsp extends GroovyPage {
...
invokeTag('form','g',27,['action':("bitacoraGestion"),'class':("col-lg-12")],1)
printHtmlPart(4)
}
...
public static final long LAST_MODIFIED = 1602714970053L
